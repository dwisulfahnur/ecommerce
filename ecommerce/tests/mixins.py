...
class BusinessIntelligenceMixin(object):
    ...
    def assert_correct_event(
            ...
            total, revenue, coupon=None, discount='0.00'
    ):
        ...
        self.assert_correct_event_payload(
            instance, event_payload, order_number, currency, total, revenue, coupon, discount
        )

    def assert_correct_event_payload(
            self, instance, event_payload, order_number, currency, total, revenue,
            coupon, discount
    ):
        """
        ...
        """
        self.assertEqual(
            ['coupon', 'currency', 'discount', 'orderId', 'products', 'revenue', 'total'],
